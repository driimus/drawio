...
var TagsWindow = function(editorUi, x, y, w, h)
{
	...
	function searchCellsByLang(cells, tag)
	{
		return graph.getCellsForTags(tag, cells, propertyName, true);
	};
	...
	var enBtn = mxUtils.button('EN', function()
	{
		showCells(searchCellsByLang('en'));
		setCellsVisible(searchCellsByLang('de'), false);
	});

	enBtn.setAttribute('title', 'EN');
	enBtn.style.marginTop = '8px';
	enBtn.style.marginRight = '4px';
	enBtn.className = 'geBtn';

	div.appendChild(enBtn);


	var deBtn = mxUtils.button('DE', function()
	{
		showCells(searchCellsByLang('de'));
		setCellsVisible(searchCellsByLang('en'), false);
	});

	deBtn.setAttribute('title', 'EN');
	deBtn.style.marginTop = '8px';
	deBtn.style.marginRight = '4px';
	deBtn.className = 'geBtn';

	div.appendChild(deBtn);
	...
	var showBtn = mxUtils.button(mxResources.get('show'), showCells(searchCells()));
